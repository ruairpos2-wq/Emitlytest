#!/usr/bin/env python3
"""
Полный цикл парсинга и импорта новостей
1. Парсит РБК (инвестиции)
2. Парсит РБК (Сбербанк)
3. Парсит Telegram @markettwits
4. Импортирует все результаты в базу данных
"""
